...
app.post("/", (req, res) => {
  const visitor = new Visitor({
    ...
    test2: {
      myAudio1: req.body.myAudio6,
      oldAudio1: req.body.oldAudio6,
      myAudio2: req.body.myAudio7,
      oldAudio2: req.body.oldAudio7,
      myAudio3: req.body.myAudio8,
      oldAudio3: req.body.oldAudio8,
      myAudio4: req.body.myAudio9,
      oldAudio4: req.body.oldAudio9,
      myAudio5: req.body.myAudio10,
      oldAudio5: req.body.oldAudio10,
    },
  });
  visitor.save();
